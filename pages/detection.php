...
<aside class="sidebar">
    ...
    <nav class="sidebar__nav">
        ...
        <a href="/pages/detection.php" class="nav-link active"><i class="fa-solid fa-magnifying-glass-plus"></i> Nouvelle analyse</a>
    ...
    <main class="content">
        ...
        <div class="result-panel show" id="resultPanel">
            ...
            <div class="result-actions">
                <a href="/pages/resultats.php?id=<?= $detectionId ?>" class="btn-action btn-action--primary">
                    <i class="fa-solid fa-eye"></i> Voir le rapport complet
                </a>
                <a href="/pages/detection.php" class="btn-action">
                    <i class="fa-solid fa-plus"></i> Nouvelle analyse
                </a>
                <a href="/pages/resultats.php" class="btn-action">
