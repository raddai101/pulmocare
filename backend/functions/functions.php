...
// WARNING: do not use function_exists('auth_login') here because PHP
// declares functions at compile time. This would always return true in
// the same file and prevent autoload/bootstrap from running.
